<?php
session_start();
if (!isset($_SESSION['parking_owner']) or empty($_SESSION['parking_owner'])) {
    ...
    <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
      <div class="position-sticky">
        <div class="list-group list-group-flush mx-3 mt-4">
          ...
          <a href="Add_Parking.php" class="list-group-item list-group-item-action py-2 ripple">
            <i class="far fa-plus-square fa-fw me-3"></i><span>Add Parking</span>
          </a>
          <a href="My_Parking.php" class="list-group-item list-group-item-action py-2 ripple">
            <i class="fas fa-truck fa-fw me-3"></i><span>My Parking</span>
          </a>
      ...
      <div class="container-fluid">
        ...
        <ul class="navbar-nav ms-auto d-flex flex-row">
          ...
          <li class="nav-item dropdown">
              ...
              <i><?php echo $_SESSION['parking_owner']; ?></i>
